/*
  # Add leaderboard achievements and stats

  1. New Tables
    - `game_achievements`
      - Tracks available achievements and their point values
    - `player_stats`
      - Tracks player statistics and total points
    - `player_achievements`
      - Records which achievements players have earned
